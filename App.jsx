...
--------------------------------------------------------- */
function getApiBase() {
  // Chat-preview build has no bundler/env support, so this always stays
  // null here (the app runs fully on demo data). The real Vite project
  // in frontend/src/App.jsx reads import.meta.env.VITE_API_BASE_URL instead.
  return null;
}
